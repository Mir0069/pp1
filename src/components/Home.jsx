          ...
          <span className="group relative min-w-72 shadow-xl block h-64 sm:h-80 lg:h-96">
            ...
            <div
              ...
              <div className="p-4 !pt-0 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8">
                ...
                <h2 className="mt-4 text-xl font-medium sm:text-2xl">Required React Developer</h2>
              </div>
              ...
              <div
                ...
                <h3 className="mt-4 text-xl font-medium sm:text-2xl">Required React Developer</h3>
          ...
          <span className="group relative shadow-xl min-w-72 ml-14 block h-64 sm:h-80 lg:h-96">
            ...
            <div
              ...
              <div className="p-4 !pt-0 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8">
                ...
                <h2 className="mt-4 text-xl font-medium sm:text-2xl">Required Graphic Designer</h2>
              </div>

              <div
                className="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 group-hover:w-72 sm:p-6 lg:p-8">
                <h3 className="mt-4 text-xl font-medium sm:text-2xl">Required Graphic Designer</h3>
          ...
          <span className="group relative shadow-xl min-w-72 ml-14 block h-64 sm:h-80 lg:h-96">
            ...
            <div
              ...
              <div className="p-4 !pt-0 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8">
                ...
                <h2 className="mt-4 text-xl font-medium sm:text-2xl">Requuired Illustrator expert</h2>
              </div>
              ...
              <div
                ...
                <h3 className="mt-4 text-xl font-medium sm:text-2xl">Requuired Illustrator expert</h3>
