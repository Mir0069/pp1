...
function App() {
    //  main div
    return <div className='w-[98vw] h-screen block mb-28' >
        {/* div for navbar dom */}
        <div>
            <Navbar />
        </div>
        ...
        {/* footer div below */}
        <div className='relative left-0 right-0 bottom-0 h-full w-full'>
            <footer className="bg-white dark:bg-gray-900  absolute bottom-0 left-0 right-0  w-full">
                <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-16 border-t border-gray-100 pt-8 dark:border-gray-800">
                        <p className="text-center text-xs/relaxed text-gray-500 dark:text-gray-400">
                            ...
                            Created with
                            <span
                                className="text-gray-700 underline transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75">Laravel</span>
                            and
                            <span
                                className="text-gray-700 underline transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75">Laravel
                                Livewire</span>.
                        </p>
                    </div>
                </div>
